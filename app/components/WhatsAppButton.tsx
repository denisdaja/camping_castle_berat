  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" width="30" height="30" fill="white">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.118 1.528 5.855L0 24l6.335-1.502A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 01-5.006-1.371l-.36-.213-3.72.882.937-3.618-.234-.372A9.818 9.818 0 1112 21.818z" />
      </svg>
    </a>
  );
}
